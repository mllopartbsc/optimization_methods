...
class TTSRequestModel(BaseModel):
    ...
    # To show Bytes test
    # sentences: list[str] = [
    #     "L'Alba viu en un poble de muntanya.",
    #     "Ella hi viu amb la seva família.",
    #     "Aquest hivern, les nevades han complicat la seva vida.",
    #     "Havien de conviure amb aquella imatge de postal, amb els carrers plens de neu.",
    #     "Els nens i les nenes estaven jugant, hi havia ninots de neu pertot arreu.",
    #     "Però, la realitat no és tan bonica com sembla.",
    #     "No hi ha escola a causa de la neu.",
    #     "La gent no pot anar a treballar perquè els vehicles no poden circular amb seguretat.",
    #     "Els veïns estan cansats de treure neu de les voreres i de les entrades de les cases.",
    #     "El més perillós de tot, és fer caure els caramells de les teulades."
    # ]
...
async def tts(request: TTSRequestModel):
    ...
    # results = pool.map(worker_with_args, sentences)
